<?php
	...
	// Copy is Derek's (2026-09-12). The entry header's summary carries his
	// intro; the one section is his section model in order - heading,
	// media, then the description paragraph.
?>
